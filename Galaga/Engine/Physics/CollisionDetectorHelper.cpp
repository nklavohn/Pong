...
bool CollisionDetectorHelper::RectWithRect(const RectHitbox* rect1, const RectHitbox* rect2)
{
...
bool CollisionDetectorHelper::RectWithCirc(const RectHitbox* rect, const CircHitbox* circ)
{
...
bool CollisionDetectorHelper::RectWithPoint(const RectHitbox* rect, const PointHitbox* point)
{
	Vector2 pointCenter = point->GetCenter();
	return rect->IsPointInside(pointCenter);
}

bool CollisionDetectorHelper::CircWithCirc(const CircHitbox* circ1, const CircHitbox* circ2)
{
...
bool CollisionDetectorHelper::CircWithPoint(const CircHitbox* circ, const PointHitbox* point)
{
	Vector2 pointCenter = point->GetCenter();
	return circ->IsPointInside(pointCenter);
}

bool CollisionDetectorHelper::PointWithPoint(const PointHitbox* point1, const PointHitbox* point2)
{
